...
; "Apps & Features". Run `python build.py` first — this packages dist\Nuclear Option Armory.exe.
;
...
#define MyAppName "Nuclear Option Armory"
#define MyAppVersion "0.1.0"
#define MyAppPublisher "DomesticNukes"
#define MyAppExeName "Nuclear Option Armory.exe"
#define MyAppURL "https://github.com/DomesticNukes/Nuclear-Option-Armory"
...
OutputBaseFilename=Nuclear Option Armory Setup
...
[Files]
Source: "dist\Nuclear Option Armory.exe"; DestDir: "{app}"; Flags: ignoreversion
